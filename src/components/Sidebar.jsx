          ...
          return (
            <button
              ...
              className={`w-full rounded-xl px-3 py-2 text-left text-sm font-medium transition-all duration-200 ${
                active === item
                  ? "bg-green-200 text-green-800 dark:bg-emerald-900/60 dark:text-emerald-200 border-l-4 border-green-600"
                  : "text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800 transition-colors duration-150"
              }`}
            >
